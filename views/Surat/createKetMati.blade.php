...
<div class="col-md-12">
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                <div class="text-center" style="font-size:20px "><b>SURAT KETERANGAN KEMATIAN</b></div>
                <div class="text-center" style="font-size:15px ">Nomor : 474.3 / . . . / Pem</div>
            </div>
        ...
        <br>
        <div class="row">
            <div class="col-xs-12">Yang bersangkutan tersebut diatas adalah penduduk Desa Baru Kecamatan Benua Kayong Kabupaten Ketapang. <br>
            Bahwa nama tersebut diatas telah meninggal dunia pada :</div>
        </div>
        <br>
        <div class="row">
            <label for="" class="control-label col-md-3 col-sm-3 col-xs-12"> Hari </label>
            <div class="col-md-6 col-sm-6 col-xs-12">: 
                
            </div>
        </div>
        <div class="row">
            <label for="" class="control-label col-md-3 col-sm-3 col-xs-12"> Tanggal </label>
            <div class="col-md-6 col-sm-6 col-xs-12">: 
                
            </div>
        </div>
        <div class="row">
            <label for="" class="control-label col-md-3 col-sm-3 col-xs-12"> Jam </label>
            <div class="col-md-6 col-sm-6 col-xs-12">: 
                
            </div>
        </div>
        <div class="row">
            <label for="" class="control-label col-md-3 col-sm-3 col-xs-12"> Tempat </label>
            <div class="col-md-6 col-sm-6 col-xs-12">: 
                
            </div>
        </div>
        <div class="row">
            <label for="" class="control-label col-md-3 col-sm-3 col-xs-12"> Dikarenakan </label>
            <div class="col-md-6 col-sm-6 col-xs-12">: 
