...
<div class="col-md-12">
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                <div class="text-center" style="font-size:20px "><b>SURAT KETERANGAN USAHA</b></div>
                <div class="text-center" style="font-size:15px ">Nomor : 511.1/ . . . /Ekbang</div>
            </div>
        ...
        <br>
        <div class="row">
            <div class="col-xs-12">Yang namanya tersebut diatas adalah benar Penduduk Desa Baru Kecamatan Benua Kayong Kabupaten Ketapang dan yang bersangkutan memang benar - benar ada usaha : </div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="row">
            <label for="" class="control-label col-md-3 col-sm-3 col-xs-12"> - Bidang Usaha</label>
            <div class="col-md-6 col-sm-6 col-xs-12">: . . . . . . . . . . . . . . .</div>
        </div>
        <div class="row">
            <label for="" class="control-label col-md-3 col-sm-3 col-xs-12"> - Alamat Usaha</label>
            <div class="col-md-6 col-sm-6 col-xs-12">: . . . . . . . . . . . . . . .</div>
        </div>
        <div class="row">
            <label for="" class="control-label col-md-3 col-sm-3 col-xs-12"> - Mulai Usaha</label>
            <div class="col-md-6 col-sm-6 col-xs-12">: . . . . . . . . . . . . . . .</div>
        </div>
        <div class="row">
            <label for="" class="control-label col-md-3 col-sm-3 col-xs-12"> - Nama Usaha</label>
            <div class="col-md-6 col-sm-6 col-xs-12">: . . . . . . . . . . . . . . .</div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="row">
            <div class="col-xs-9"></div>
             <div class="col-xs-3">KEPALA DESA BARU</div>
        </div>
        <br>
        <div class="row">
            <div class="col-xs-9"></div>
             <div class="col-xs-3"><u><b>A D N I</b></u></div>
        </div>
        </div>
