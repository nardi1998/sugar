...
<div class="col-md-12">
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                <div class="text-center" style="font-size:20px "><b>SURAT PENGANTAR SKCK</b></div>
                <div class="text-center" style="font-size:15px ">Nomor :...../...../...../.....</div>
            </div>
        ...
        <br>
        <div class="row">
            <div class="col-xs-12">Yang bersangkutan sepanjang pengetahuan kami, selama bertempat tinggal di wilayah Hukum kami menunjukkan sikap dan perbuatan serta tingkah laku yang baik dan belum pernah tersangkut dalam perkara Kepolisian ataupun perbuatan yang melanggar hukum lainnya baik di Desa maupun di lingkungannya</div>
        </div>
        <br>
        <div class="row">
            <div class="col-xs-12">Dengan Catatan :</div>
        </div><br>
        <div class="row">
            <label for="" class="control-label col-xs-12"> 1. Rekomendasi ini tidak merupakan jaminan atas tindakan hukum sewaktu - waktu</label>
        </div><div class="row">
            <label for="" class="control-label col-xs-12"> 2. Rekomendasi ini diberikan kepada yang bersangkutan untuk mendapatkan Surat Kelakuan Baik yang sah dari Kepolisian</label>
        </div>
        <br>
        <div class="row">
